...
Scan images submitted for recognition are uploaded to a private, access-controlled storage area and shared with these providers via short-lived signed links. We do not send your name, email, or account details to AI providers with your images.
