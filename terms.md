...
- **License to us.** You grant us a worldwide, non-exclusive, royalty-free license to host, store, reproduce, process, transmit, display (to you), and create derivative works of Your Content **solely as needed to operate, provide, secure, and improve the App** — including transmitting your photos to the third-party AI and infrastructure providers identified in the Privacy Policy for recognition and processing. This license ends when Your Content is deleted, except for residual copies in backups for a limited period and content we must retain by law.
